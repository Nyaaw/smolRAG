...
class TestFlatten:
    ...
    def test_depth_first_children_after_parent(self):
        a = _cs("a", "a.java", 0, 0, source="lsp")
        a1 = _cs("a1", "a1.java", 0, 0, source="enrichment (parent)", parent=a)
        a2 = _cs("a2", "a2.java", 0, 0, source="enrichment (parent)", parent=a)
    ...
    def test_depth_first_complex_tree(self):
        a = _cs("a", "a.java", 0, 0, source="lsp")
        a1 = _cs("a1", "a1.java", 0, 0, source="enrichment (parent)", parent=a)
        a2 = _cs("a2", "a2.java", 0, 0, source="enrichment (containing class)", parent=a)
        b = _cs("b", "b.java", 0, 0, source="lsp")
        b1 = _cs("b1", "b1.java", 0, 0, source="enrichment (parent)", parent=b)
    ...
    def test_missing_parent_ignored(self):
        ...
        orphan = _cs("orphan", "orphan.java", 0, 0, source="enrichment (parent)")
    ...
    def test_single_root_with_many_children_preserves_child_order(self):
        ...
        a1 = _cs("a1", "a1.java", 0, 0, source="enrichment (parent)", parent=a)
        a2 = _cs("a2", "a2.java", 0, 0, source="enrichment (containing class)", parent=a)
        a3 = _cs("a3", "a3.java", 0, 0, source="enrichment (parent)", parent=a)
    ...
    def test_avoids_cycles(self):
        a = _cs("a", "a.java", 0, 0, source="lsp")
        b = _cs("b", "b.java", 0, 0, source="enrichment (parent)", parent=a)
